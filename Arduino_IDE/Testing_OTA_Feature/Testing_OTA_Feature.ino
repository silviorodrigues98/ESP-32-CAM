...
const char* ssid = "akso"; /* coloque aqui o nome da rede wi-fi que o ESP32 deve se conectar */
const char* password = "111333555"; /* coloque aqui a senha da rede wi-fi que o ESP32 deve se conectar */
